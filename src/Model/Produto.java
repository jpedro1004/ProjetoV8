...
public class Produto {
    ...
    // Altera o produto
    public boolean UpdateProdutoBD(int id, String nomeProduto, String descricaoProduto, int quantidadeProduto, float precoProduto, LocalDate dataCadastro, String categoriaProduto, String editoraProduto, String autorProduto, int anoLancamento) {
        Produto objeto = new Produto(id, nomeProduto, descricaoProduto, quantidadeProduto, precoProduto, dataCadastro, categoriaProduto, editoraProduto, autorProduto, anoLancamento);
